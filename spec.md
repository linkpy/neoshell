...
# Neoshell Language Specification
 ...
 - [1. Syntax](#1-syntax)
   ...
   - [1.4. Descriptors](#14-descriptors)
     - [1.4.1. Argument descriptors](#141-argument-descriptors)
	   - [1.4.1.1. Positional argument descriptors](#1411-positional-argument-descriptors)
	   - [1.4.1.2. Positional list argument descriptors](#1412-positional-list-argument-descriptors)
	   - [1.4.1.3. Flag argument descriptors](#1413-flag-argument-descriptors)
	   - [1.4.1.4. Option argument descriptors](#1414-option-argument-descriptors)
	   - [1.4.1.5. List argument descriptors](#1415-list-argument-descriptors)
	   - [1.4.1.6. Choice argument descriptors](#1416-choice-argument-descriptors)
	   - [1.4.1.7. Named choice argument descriptors](#1417-named-choice-argument-descriptors)
	   - [1.4.1.8. Multi-choice argument descriptors](#1418-multi-choice-argument-descriptors)
	   - [1.4.1.9. Named multi-choice argument descriptors](#1419-named-multi-choice-argument-descriptors)
 ...
 - [2. Language's constructs](#2-languages-constructs)
